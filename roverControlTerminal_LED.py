...
PIN_LED_MODE   = 22  # was 16 (now safe)
PIN_LED_ESTOP  = 25  # was 26 (now safe)
...
try:
    while running:
        ...
        # Non-blocking LED logic (ESTOP indicator window — mirrors, but ESTOP state keeps them off)
        ...
        if state == State.ESTOP:
            # Keep all indicators off during ESTOP
