#!/usr/bin/env python3
# oled_two_buttons_with_leds.py — SSD1306 OLED + 2 buttons (17,23) + 2 LEDs (22,25)
...
PIN_LED_MODE   = 5   # MODE LED
PIN_LED_ESTOP  = 6   # ESTOP LED
...
# Track virtual LED visibility for edge logging
mode_vis_on  = False
estop_vis_on = False
...
try:
    while running:
        ...
        # In ESTOP, ensure MODE LED stays off (ESTOP LED handled by its timer)
